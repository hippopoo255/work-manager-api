...
- サイトリンク：
~~https://job-support.site~~
[https://work-manager.site](https://work-manager.site)（2022.10 URL変更しました）
...
レスポンスタイム短縮のため、メール送信については原則非同期処理を選択しました。
**Laravel**で用意されている**Notification** クラス内で **Queueable** を使用することでキューへ投入しております。

また、定時のメール配信（**当日の予定** や **締切の迫ったTODO** のお知らせ）については、別途 **Supervisor** 用の Docker コンテナを立ち上げ、cronのプロセスを監視することで実現しております。

#### メール通知が起こるケース

- 他のユーザから新しく予定が共有されたとき
- 他のユーザが新規登録した会議議事録について、会議参加者に自分が加えられていた時
